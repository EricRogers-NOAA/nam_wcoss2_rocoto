#!/bin/sh
#PBS -N nam_profile_12_f50
#PBS -l select=1:ncpus=1:mem=4GB
#PBS -l walltime=00:05:00
#PBS -e /lfs/h2/emc/lam/noscrub/Eric.Rogers/nam.v4.2.0/logs/nam_profile_f50_12.out
#PBS -o /lfs/h2/emc/lam/noscrub/Eric.Rogers/nam.v4.2.0/logs/nam_profile_f50_12.out
#PBS -q dev
#PBS -A NAM-DEV
#PBS -l debug=true
#PBS -V
...
export fhr=50
export jobid=jnam_profile_f50_${cyc}.${PBS_JOBID}
export job=nam_profile_f50_${cyc}
