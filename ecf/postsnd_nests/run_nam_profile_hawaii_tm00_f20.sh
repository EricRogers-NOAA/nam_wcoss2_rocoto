#!/bin/sh
#PBS -N nam_profile_hawaii_12_f20
#PBS -l select=1:ncpus=1:mem=10GB
#PBS -l walltime=00:05:00
#PBS -e /lfs/h2/emc/lam/noscrub/Eric.Rogers/nam.v4.2.0/logs/nam_profile_hawaii_f20_12.out
#PBS -o /lfs/h2/emc/lam/noscrub/Eric.Rogers/nam.v4.2.0/logs/nam_profile_hawaii_f20_12.out
#PBS -q dev
#PBS -A NAM-DEV
#PBS -l debug=true
#PBS -V
...
export fhr=20
export jobid=jnam_profile_hawaii_f20_${cyc}.${PBS_JOBID}
export job=nam_profile_hawaii_f20_${cyc}
