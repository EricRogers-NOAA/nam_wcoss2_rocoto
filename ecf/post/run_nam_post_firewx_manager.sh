#!/bin/sh
#PBS -N nam_post_firewx_manager_12
#PBS -l select=1:ncpus=1:mem=200MB
#PBS -l walltime=02:20:00
#PBS -e /lfs/h2/emc/lam/noscrub/Eric.Rogers/nam.v4.2.0/logs/nam_post_firewx_manager_12.out
#PBS -o /lfs/h2/emc/lam/noscrub/Eric.Rogers/nam.v4.2.0/logs/nam_post_firewx_manager_12.out
#PBS -q dev
#PBS -A NAM-DEV
#PBS -l debug=true
#PBS -V
...
export jobid=jnam_post_firewx_manager_${cyc}.${PBS_JOBID}
export job=nam_post_firewx_manager_${cyc}
