#!/bin/sh
#PBS -N nam_post_12_f25
#PBS -l select=1:ncpus=28:mem=28GB
#PBS -l walltime=00:20:00
#PBS -e /lfs/h2/emc/lam/noscrub/Eric.Rogers/nam.v4.2.0/logs/nam_post_f25_12.out
#PBS -o /lfs/h2/emc/lam/noscrub/Eric.Rogers/nam.v4.2.0/logs/nam_post_f25_12.out
#PBS -q dev
#PBS -A NAM-DEV
#PBS -l debug=true
#PBS -V
...
export jobid=jnam_post_f25_${cyc}.${PBS_JOBID}
export job=jnam_post_f25_${cyc}
