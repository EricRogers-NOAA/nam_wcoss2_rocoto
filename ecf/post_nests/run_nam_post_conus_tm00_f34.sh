#!/bin/sh
#PBS -N nam_post_conus_12_f34
#PBS -l select=1:ncpus=28:mem=100GB
#PBS -l walltime=00:20:00
#PBS -e /lfs/h2/emc/lam/noscrub/Eric.Rogers/nam.v4.2.0/logs/nam_post_conus_f34_12.out
#PBS -o /lfs/h2/emc/lam/noscrub/Eric.Rogers/nam.v4.2.0/logs/nam_post_conus_f34_12.out
#PBS -q dev
#PBS -A NAM-DEV
#PBS -l debug=true
#PBS -V
...
export jobid=jnam_post_conus_f34_${cyc}.${PBS_JOBID}
export job=nam_post_conus_f34_${cyc}
