...
#PBS -l place=scatter:excl,select=20:ncpus=128
...
mkdir -p /lfs/h2/emc/stmp/Eric.Rogers/testfcst.tm06_erexec20_mine
cd /lfs/h2/emc/stmp/Eric.Rogers/testfcst.tm06_erexec20_mine
