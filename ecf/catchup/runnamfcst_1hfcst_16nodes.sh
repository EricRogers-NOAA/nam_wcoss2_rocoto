...
#PBS -l place=scatter:excl,select=16:ncpus=128
...
mkdir -p /lfs/h2/emc/stmp/Eric.Rogers/testfcst.tm06_erexec16_mine1
cd /lfs/h2/emc/stmp/Eric.Rogers/testfcst.tm06_erexec16_mine1
