...
mkdir -p /lfs/h2/emc/stmp/Eric.Rogers/testfcst.tm06_erexec_orig
cd /lfs/h2/emc/stmp/Eric.Rogers/testfcst.tm06_erexec_orig
...
mpiexec -n ${ntasks} -ppn ${ppn} --cpu-bind core --depth ${threads} $EXEC > pgmout.c5 2>errfile.c5
