#!/bin/sh
#PBS -N nam_catchup_post_tm03_f01_12
#PBS -l select=1:ncpus=28:mem=28GB
#PBS -l walltime=00:20:00
#PBS -e /lfs/h2/emc/lam/noscrub/Eric.Rogers/nam.v4.2.0/logs/nam_catchup_post_tm03_f01_12
#PBS -o /lfs/h2/emc/lam/noscrub/Eric.Rogers/nam.v4.2.0/logs/nam_catchup_post_tm03_f01_12
#PBS -q dev
#PBS -A NAM-DEV
#PBS -l debug=true
#PBS -V
...
export jobid=jnam_catchup_post_tm03_f01_${cyc}.${PBS_JOBID}
export job=nam_catchup_post_tm03_f01_${cyc}
