#!/bin/sh
#PBS -N nam_catchup_forecast_tm03_12
#PBS -l place=vscatter:excl,select=16:ncpus=128:mpiprocs=64:ompthreads=2
#PBS -l walltime=00:45:00
#PBS -e /lfs/h2/emc/lam/noscrub/Eric.Rogers/nam.v4.2.0/logs/nam_catchup_forecast_tm03_12.out
#PBS -o /lfs/h2/emc/lam/noscrub/Eric.Rogers/nam.v4.2.0/logs/nam_catchup_forecast_tm03_12.out
#PBS -q dev
#PBS -A NAM-DEV
#PBS -l debug=true
####PBS -l hyper=true
...
export job=nam_catchup_forecast.${tmmark}_${cyc}
