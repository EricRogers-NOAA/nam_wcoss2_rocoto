...
mkdir -p /lfs/h2/emc/stmp/Eric.Rogers/testfcst.40nodes_18z_ncoexec
cd /lfs/h2/emc/stmp/Eric.Rogers/testfcst.40nodes_18z_ncoexec
cp /lfs/h2/emc/ptmp/Eric.Rogers/naminput.2021082418/* .
...
mpiexec --line-buffer --label -n 2520 -ppn 63 --cpu-bind depth --depth 2 $EXECnam_nco > pgmout.c5 2>errfile.c5
###mpiexec --line-buffer --label -n 2520 -ppn 63 --cpu-bind depth --depth 2 $EXECnam > pgmout.c5 2>errfile.c5
