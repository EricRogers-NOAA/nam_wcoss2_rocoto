#!/bin/sh
#PBS -N nam_catchup_post_alaska_tm02_f01_12
...
export jobid=jnam_catchup_post_alaska_tm02_f01_${cyc}.${PBS_JOBID}
export job=nam_catchup_post_alaska_tm02_f01_${cyc}
