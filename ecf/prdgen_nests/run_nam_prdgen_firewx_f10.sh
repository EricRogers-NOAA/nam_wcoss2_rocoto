#!/bin/sh
#PBS -N nam_prdgen_firewx_f10_12
#PBS -l select=1:ncpus=1:mem=12GB
#PBS -l walltime=00:20:00
#PBS -e /lfs/h2/emc/lam/noscrub/Eric.Rogers/nam.v4.2.0/logs/nam_prdgen_firewx_f10_12.out
#PBS -o /lfs/h2/emc/lam/noscrub/Eric.Rogers/nam.v4.2.0/logs/nam_prdgen_firewx_f10_12.out
#PBS -q dev
#PBS -A NAM-DEV
#PBS -l debug=true
#PBS -V
...
export SENDCOM=YES
export SENDDBN=NO
export jobid=jnam_prdgen_firewx_f10_${cyc}.${PBS_JOBID}
export job=nam_prdgen_firewx_f10_${cyc}
