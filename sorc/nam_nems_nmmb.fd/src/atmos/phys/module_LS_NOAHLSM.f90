...
!                                                                       
      ...
      IF ( mype_share==0 ) THEN
        ...
        OPEN(19, FILE='VEGPARM.TBL',FORM='FORMATTED',STATUS='OLD',IOSTAT=ierr)  
             IF(ierr .NE. OPEN_OK ) THEN
               ...
               write(0,*)' ABORTING!'
               CALL ESMF_FINALIZE(endflag=ESMF_END_ABORT,rc=ierr)
             END IF
 ...
 2002   IF(LUCATS<=0) THEN
          write(0,*) 'Problem reading vegetation tables (VEGPARM.TBL)'
          write(0,*)' ABORTING!'
          CALL ESMF_FINALIZE(endflag=ESMF_END_ABORT,rc=ierr)
        ENDIF

LU_test: IF(LUTYPE.EQ.MMINLU)THEN                                        
          LUMATCH=1                                                     
...
!
          ...
          READ (19,*)BARE
        ELSE   LU_test
          write(0,*) 'Mismatched vegetation tables (VEGPARM.TBL)'
          write(0,*) 'MMINLU=',MMINLU,' and LUTYPE=',LUTYPE
          write(0,*)' ABORTING!'
          CALL ESMF_FINALIZE(endflag=ESMF_END_ABORT,rc=ierr)
        ENDIF  LU_test
!
...
!
 ...
 2003   IF(SLCATS<=0) THEN
          write(0,*) 'Problem reading soil tables (SOILPARM.TBL)'
          write(0,*)' ABORTING!'
          CALL ESMF_FINALIZE(endflag=ESMF_END_ABORT,rc=ierr)
        ENDIF
...
SL_test: IF(SLTYPE.EQ.MMINSL)THEN                                    
          DO LC=1,SLCATS                                                
          ...
          ENDDO
        ELSE   SL_test
          write(0,*) 'Mismatched soil tables (SOILPARM.TBL)'
          write(0,*) 'MMINSL=',MMINSL,' and LUTYPE=',SLTYPE
          write(0,*)' ABORTING!'
          CALL ESMF_FINALIZE(endflag=ESMF_END_ABORT,rc=ierr)
        ENDIF  SL_test
